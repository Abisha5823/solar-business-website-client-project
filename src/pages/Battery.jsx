        ...
        <div className="container-page">
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="card p-7 md:p-8" data-aos="fade-up">
              <div className="kicker w-fit">Handled under Annbu Battery Service</div>
              ...
              <div className="mt-4 rounded-2xl border border-orange-200 bg-orange-50 p-4 text-sm text-zinc-700">
                ...
                <div className="mt-1">
                  We supply trusted battery brands and provide product guidance and clean installation support.
                </div>
              </div>
              <div className="mt-4 rounded-2xl border border-zinc-200 bg-white p-4">
                <div className="text-sm font-extrabold text-ink-900">Brands</div>
                <div className="mt-3 flex flex-wrap gap-2">
                  {["Exide", "Amaron", "Tata", "Amaze", "Microtek"].map((b) => (
                    <span
                      key={b}
